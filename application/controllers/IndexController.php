...
class IndexController extends Zend_Controller_Action {
	...
	public function mostrarAction() {
		...
		$model_comentarios = new Application_Model_Comentarios();
		$comentarios = $model_comentarios->getComentariosPorPost($idPost);
		$this->view->comentarios = $comentarios;
		
		$form = new Application_Form_ComentarioForm();
		$this->view->form = $form;
	...
	public function testeAction() {
		...
		$dados = array(
			...
			"email"=>"eduardo.bona@cesumar.br"
		);
		
		$model = new Application_Model_Comentarios();
